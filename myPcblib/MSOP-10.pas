...
Procedure CreateComponentMSOP_10(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp := CreateAComponent('MSOP-10');
        NewPcbLibComp.Name := 'MSOP-10';
        NewPCBLibComp.Description := 'Small Outline Pkg (SOP), 0.50 mm pitch; 10 pin, 3.00 mm L X 3.00 mm W X 1.10 mm H body';
        ...
        CreateSMDComponentPad(NewPCBLibComp, '1', eTopLayer, -1, -2.015, 0, 0, eRoundedRectangular, 1.27, 0.31, 270, 51.61, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '2', eTopLayer, -0.5, -2.015, 0, 0, eRoundedRectangular, 1.27, 0.31, 270, 51.61, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '3', eTopLayer, 0, -2.015, 0, 0, eRoundedRectangular, 1.27, 0.31, 270, 51.61, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '4', eTopLayer, 0.5, -2.015, 0, 0, eRoundedRectangular, 1.27, 0.31, 270, 51.61, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '5', eTopLayer, 1, -2.015, 0, 0, eRoundedRectangular, 1.27, 0.31, 270, 51.61, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '6', eTopLayer, 1, 2.015, 0, 0, eRoundedRectangular, 1.27, 0.31, 90, 51.61, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '7', eTopLayer, 0.5, 2.015, 0, 0, eRoundedRectangular, 1.27, 0.31, 90, 51.61, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '8', eTopLayer, 0, 2.015, 0, 0, eRoundedRectangular, 1.27, 0.31, 90, 51.61, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '9', eTopLayer, -0.5, 2.015, 0, 0, eRoundedRectangular, 1.27, 0.31, 90, 51.61, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '10', eTopLayer, -1, 2.015, 0, 0, eRoundedRectangular, 1.27, 0.31, 90, 51.61, 0, 0, True, True);

        CreateComponentTrack(NewPCBLibComp, -1.11, -1.825, -0.89, -1.825, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.89, -1.825, -0.89, -2.425, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.89, -2.425, -1.11, -2.425, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1.11, -2.425, -1.11, -1.825, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.61, -1.825, -0.39, -1.825, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.39, -1.825, -0.39, -2.425, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.39, -2.425, -0.61, -2.425, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.61, -2.425, -0.61, -1.825, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.11, -1.825, 0.11, -1.825, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.11, -1.825, 0.11, -2.425, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.11, -2.425, -0.11, -2.425, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.11, -2.425, -0.11, -1.825, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.39, -1.825, 0.61, -1.825, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.61, -1.825, 0.61, -2.425, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.61, -2.425, 0.39, -2.425, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.39, -2.425, 0.39, -1.825, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.89, -1.825, 1.11, -1.825, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.11, -1.825, 1.11, -2.425, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.11, -2.425, 0.89, -2.425, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.89, -2.425, 0.89, -1.825, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.11, 1.825, 0.89, 1.825, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.89, 1.825, 0.89, 2.425, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 0.89, 2.425, 1.11, 2.425, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.11, 2.425, 1.11, 1.825, ILayer.MechanicalLayer(21), 0.025, False);
        ...
        CreateComponentTrack(NewPCBLibComp, -1.11, 2.425, -0.89, 2.425, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -0.89, 2.425, -0.89, 1.825, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1.5, -1.5, -1.5, 1.5, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -1.5, 1.5, 1.5, 1.5, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.5, 1.5, 1.5, -1.5, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 1.5, -1.5, -1.5, -1.5, ILayer.MechanicalLayer(21), 0.025, False);
        CreateComponentArc(NewPCBLibComp, -1.555, -2.4, 0.125, 0, 360, eTopOverlay, 0.25, False);
        ...
        CreateComponentTrack(NewPCBLibComp, 1.525, -1.525, -0.525, -1.525, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -0.525, -1.525, -1.525, -0.525, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -1.525, -0.525, -1.525, 1.525, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -1.525, 1.525, 1.525, 1.525, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 1.525, 1.525, 1.525, -1.525, eMechanical9, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 1.38, -1.6, 1.6, -1.6, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, 1.6, -1.6, 1.6, 1.6, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, 1.6, 1.6, 1.38, 1.6, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, -1.38, -1.6, -1.6, -1.6, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, -1.6, -1.6, -1.6, 1.6, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, -1.6, 1.6, -1.38, 1.6, eTopOverlay, 0.15, False);
        CreateComponentTrack(NewPCBLibComp, 1.725, -1.725, 1.725, 1.725, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.725, 1.725, 1.355, 1.725, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.355, 1.725, 1.355, 2.85, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 1.355, 2.85, -1.355, 2.85, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -1.355, 2.85, -1.355, 1.725, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -1.355, 1.725, -1.725, 1.725, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -1.725, 1.725, -1.725, -1.725, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -1.725, -1.725, -1.355, -1.725, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -1.355, -1.725, -1.355, -2.85, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -1.355, -2.85, 1.355, -2.85, eMechanical15, 0.05, False);
        ...
        Model := STEPmodel.ModelFactory_FromFilename('D:\pcb\ADP\altium_libs\myPcblib\MSOP-10.STEP', false);
        STEPModel.Layer := eMechanical13;
        STEPmodel.Model := Model;
        STEPmodel.SetState_Identifier('MSOP-1');
